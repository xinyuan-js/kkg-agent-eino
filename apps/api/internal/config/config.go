...
func Load() Config {
	return Config{
		...
		KKGBlogBaseURL:  trimRightSlash(getEnv("KKG_BLOG_BASE_URL", "http://127.0.0.1:8080")),
		KKGOJBaseURL:    trimRightSlash(getEnv("KKG_OJ_BASE_URL", "http://127.0.0.1:8080/api/v1/oj")),
